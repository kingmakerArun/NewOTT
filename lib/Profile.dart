  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(" My Profile", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
        actions: [
          Padding(
              ...
              child: Column(
                children: [
                    ...
                    Row(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text("Monish", style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold),),
                        ),
                      ],
                    ),
                  ],
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left:60.0),
                            child: Text("+919791245075", style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold),),
                          ),
                        ],
                      ),
                    ],
                  ...
                  const Divider(color: Colors.red,
                    ...
                    endIndent: 10,),
                  SizedBox(height: 150,),
                  Text("By sharing this information,you agree to the", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text("Disney+ hotstar", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
